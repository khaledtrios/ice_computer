                ...
                <div class="col-12 col-md-10 col-lg-5">
                    <div class="auth-card">
                        ...
                        <form id="forgotPasswordForm" action="{{ route('password.email') }}" method="POST">
                            ...
                            <!-- Bouton d'envoi -->
                            <button type="submit" id="forgotPasswordSubmitBtn" class="btn auth-btn w-100 mb-3">
                                <span id="forgotPasswordBtnText">Envoyer le lien de réinitialisation</span>
                                <span id="forgotPasswordLoader" class="spinner-border spinner-border-sm d-none" role="status"></span>
                            </button>
